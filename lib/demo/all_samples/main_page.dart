...
import 'package:flutter_app/demo/all_samples/list/list_demo.dart';
import 'package:flutter_app/demo/all_samples/normal_page.dart';
import 'package:flutter_app/demo/all_samples/router/router_demo.dart';
...
class MainActivity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Widget> widgets = <Widget>[
      buildClicks2(buildContents('默认页面'), context,MyHomePage()),
      buildClicks2(buildContents('路由用法Demo'), context, RouterDemo()),
      buildClicks2(
          buildContents('ListView用法Demo'), context, ListViewDemos()),
